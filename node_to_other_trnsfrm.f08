...
contains
  ...
  contains
    ...
    subroutine NI_models_trmnlNode_to_spr
      ...
      !I want the rght_endNode(2) for starting position, this is for getting that rght_endNode(2) at CellsMeet=0, as rght_endNode(2) is achanging
      
      trmnl = 1
      
      write(*,*) rght_endNode,"rghtEndNode"
      write(*,*) lft_endNode, "lftEndNode"
      ...
      if (stageNo==1 .and. stageType==1) then
         ...
         write(35,fmt=*) Init_rghtEndNode1,Init_lftEndNode1,"Init1"
         write(35,fmt=*) Init_rghtEndNode2,Init_lftEndNode2,"Init2"
               ...
               do j = 1,jmax
                  ...
                  if (trmnl_intrmdSpr(spr_Prv,0)==1) then
                     ...
                     if (j==1) then
                        ...
                        if(i==2.or.i==(Init_lftEndNode2+2)) then
                           node_spr(i,cnt) = trmnl_intrmdSpr(spr_Prv,1)
                        else
