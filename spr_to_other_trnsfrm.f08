...
contains
  ...
  subroutine get_spr_to_node_transfrm_TN_model
    ...
    count_spr = 0
    !write(*,*) count_spr,"inside_node_transform"
    ...
    do lp_cnt = 1,max_blck
       ...
       elseif (wntbb(lp_cnt) == 4) then
          ...
          !write(*,*) cnnctng_node,"cnnctng_node"
    ...
    subroutine lft_spr_to_node
      ...
      do i = 1,nsl
         ...
         if (mod(i,3) .ne. 0) then
            ...
            !will rethink later if needed as it will work if (123 or 456 or 789 in the same cell but wont work if 678 or 234 are in the same cell)
