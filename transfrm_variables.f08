module transfrm_info
  ...
  integer :: max_node_spr,max_node_sprS
  integer :: max_node_nospr
  integer :: max_area_spr,max_area_sprS
  
  integer :: max_spr_node, max_spr_nodeS
  integer :: max_area_node,max_area_nodeS
  
  integer :: max_node_area,max_node_areaS
  integer :: max_spr_area, max_spr_areaS
  
  integer, allocatable :: spr_node(:,:),spr_nodeS(:,:)
  integer, allocatable :: sprless_node(:,:)
  integer, allocatable :: spr_area(:,:),spr_areaS(:,:)
  
  integer, allocatable :: node_spr(:,:),node_sprS(:,:)
  integer, allocatable :: node_area(:,:),node_areaS(:,:)
  
  integer, allocatable :: area_spr(:,:),area_sprS(:,:)
  integer, allocatable :: area_node(:,:),area_nodeS(:,:)
  
  integer, allocatable :: Nlist(:,:,:),NlistS(:,:,:)
...
contains
  ...
  subroutine deallocate_and_reallocate_transfrmStr_variables
    ...
    write(*,*) max_node_spr,max_area_spr,max_spr_node,max_area_node,max_node_area,max_spr_area,"max values"
