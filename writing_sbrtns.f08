...
contains
  ...
  subroutine save_config_and_generate_ColorData(dum_coordntes,duml0,dumA0,ExpNo,frmeNo)
    ...
    do i=1,N_spr
       write(21,fmt=*) Tension(i),i,"Tension,spr_nm"
    enddo
  ...
  subroutine read_config_and_start_simlnFrm_there(ExpNo,FrmNoToBeRead)
    ...
    flNmN_arr(1)=flNmN
    call read_nodeXY_and_CgVals_frmAFile(NumChar,flNmN)
  ...
  subroutine read_nodeXY_and_CgVals_frmAFile(NumChar,flnm_arr)
    ...
    do   
       ...
       write(*,*) nodeRead(1:N_dmnsn),nodeCnt,nodeTval,CgXval,CgYval
...
subroutine writing_nodes_over_spr_single_node(dum_Nodes,Tension,ExpNo,frmeNo)
  ...
  do i1 = 0,(N_spr+1)
     ...
     elseif (i1==(N_spr+1)) then
        ...
        !if (AddedCellModelInitiation==0 .and. modelID==2) then
           
         !  write(*,*) strtNode,fnshNode,nvsl,N_TNsAC,"strtfnsh1"
          ! strtNode = (2*nvsl)+1
           !fnshNode = (2*nvsl)+2
           
           !write(*,*) strtNode,fnshNode,nvsl,N_TNsAC,"strtfnsh2"
           !stop
        !endif
