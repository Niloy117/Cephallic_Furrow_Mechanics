...
N_iter = 2 #46#14#399#44#47#388#224#27#56#57#28#74#42#17#13
nstrt  = 1
nend   = N_iter
...
stressScaleA = 0.12 #0.33 #0.37 #0.37
stressScaleS = 0.38 #1.06 #1.01 #1.51 #0.76 #1.20 #1.12
...
do for [n=1:N_iter]{
   ...
   if (nodeInsrtdOrNot==1) {
      datafileArea = datadir.sprintf('NI_modelInitiatnAW%03d.dat',n)
      datafileSpr  = datadir.sprintf('NI_modelInitiatnSW%03d.dat',n)}   
