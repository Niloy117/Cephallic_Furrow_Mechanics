...
f12=Energy_tree #done
f13=gradient_calcEnrgy #done
f14=gradient_calcPenF #done
f15=PenF_and_Wfunc #done

f16=mltiple_calls_together #done
f17=Minimizer_Routines_CGMethod #done
f18=PenF_minimizer #done
f19=Time_Stepping #done

f20=Force_calc_switching_off_mech #done
f21=optimizing_shape #done
f22=writing_sbrtns #done

f23=node_insertion_model #done
f24=nodeInsrtd_cntrlStates #done
f25=AddedCell_model #done
f26=ManipltngEquilibrateForInitiatn #done
f27=Manipulating_and_Equilibrate #done

f28=redefine_system #done
f29=calls_for_tests #done

f30=propTrnsfer #done
f31=build_strctures #done
f32=readjust_two_step_trnsfrmtn #done
f33=multiple_cycle #done

f34=Fundamental_routines #done
f35=circle_center #done
f36=complt_simltn #done
f37=main_blcks #done
...
$compiler $gflags $file1 $file2 $file3 $file4 $file5 $file6 $file7 $file8 $file9 $file10 $file11 $file12 $file13 $file14 $file15 $file16 $file17 $file18 $file19 $file20 $file21 $file22 $file23 $file24 $file25 $file26 $file27 $file28 $file29 $file30 $file31 $file32 $file33 $file34 $file35 $file36 $file37 -o $executableFile
