...
contains
  ...
  subroutine stage1_type1
    ...
    do i1=1,N_seq
       write(*,*) i1,dataUpdtd(i1),"dataUpdtd Val"
    enddo
    ...
    elseif (SaveOrReadData==2 .or. SaveOrReadData==3) then
       ...
       do iMain = 1,N_seq
          ...
          elseif (iMain.lt.9) then
             ...
             !call trnsfrm_btwn_strcts_inTwoSteps_S1(strct_INPT,strct_OTPT) !regular cases [either this line or next line]
             call running_for_with_Force_InitPhase(iMain,whichEnd,dataUpdtd,strct_INPT,strct_OTPT,saveWhom)
             
             !if (iMain==8) then
             !   write(*,*) "stopping after initiation phase"
             !   stop
             !endif
       ...
       stop
       Exprmnt=28 ; Frame=1
       call Property_Trnsfr_ToNextCell
       !Exprmnt=29 ; Frame=1
       !call PrgrsnStgCyclicMovement
       !Exprmnt=31 ; Frame=1
       !call PrgrsnStgCyclicMovement_Separately
  ...
  subroutine running_for_with_Force_InitPhase(iMain,whichEnd,dataUpdtd,strct_INPT,strct_OTPT,saveWhom)
    implicit none
  ...
  end subroutine running_for_with_Force_InitPhase
