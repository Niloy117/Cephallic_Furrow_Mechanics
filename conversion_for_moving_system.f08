module moving_coordnte_info
  ...
  implicit none
  real*8 , allocatable :: coordntes(:),coordntesStr(:),coordntesStrAN(:),coordntesStrES(:)
  real*8 , allocatable :: coordntes_xy(:),coordntes_xyStr(:),coordntes_xyStrAN(:),coordntes_xyStrES(:)
  
  integer, allocatable :: coordnte_of_which_node(:),coordnte_of_which_nodeStr(:)
  integer, allocatable :: coordnte_of_which_nodeStrAN(:),coordnte_of_which_nodeStrES(:)
  
  integer, allocatable :: x_or_y(:),x_or_yStr(:),x_or_yStrAN(:),x_or_yStrES(:)
