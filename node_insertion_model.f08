...
contains
  ...
  subroutine switch_to_NI_model
    ...
    call get_CgXvars ; call get_CgYvars
    ...
    call deallocate_and_reallocate_NI_trnsfrmVars
  ...
  subroutine get_NodeVars
    ...
    !do i = 1,N_nodeS
     !  write(*,*) node_xy(i,1:2),i,"in node_insertn model"
    !enddo
  ...
  subroutine get_kphi_and_nodePhiTyp
    ...
    !do i = 1,N_node
     !  write(*,*) k_phi(i,1:max_Phi_node),i,"k_phi,i"
    !enddo
  ...
  subroutine TN_and_NI_modelSpr_trnsfrmtn
    ...
    open(unit=197,file='TrmnlIntrmdSpr.dat')
  ...
  subroutine deallocate_and_reallocate_NI_trnsfrmVars
    implicit none
    ...
    if (SystemTyp .ne. 1) then
       ...
       max_spr_node  = 6
       max_area_node = 4 
       max_node_area = 5+(3*NAEC) ! 5+(3*1) --> MaxNo_curve_in_Each_cell*NAEC
  ...
  end subroutine deallocate_and_reallocate_NI_trnsfrmVars
