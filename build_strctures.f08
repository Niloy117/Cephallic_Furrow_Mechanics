...
contains
  ...
  subroutine adjusting_routines_in_trnsfrm_strcts_S1(strct_INPT,strct_OTPT)
    ...
    elseif (strct_INPT==3 .and. strct_OTPT==4) then ! 2
       ...
       !do cntV=1,N_node
          !write(*,*) node_xy(cntV,1:2),"nodeVal"
          !write(*,*) CgXNode(cntV),CgYNode(cntV),cntV,"cntV"
       !enddo
       
       !do cntV = 1,N_mvCoordnte
       !   write(*,*) coordntes_xy(cntV),"coordnte XY Val"
       !enddo
       ...
       call print_NI_trnsfrms_inFiles
  ...
  subroutine trnsfrm_btwn_strcts_inTwoSteps_S1_with_condn(hlfCycl,strct_INPT,strct_OTPT)
    ...
    do i = 0,(N_step)
       ...
       if (hlfCycl==1) then 
          ...
          if (i==0) then
             call deformation_tests_using_one_or_multiple_cells
             stop
             call taken_from_inside_of_tbsitsS1wc
             write(*,*) "stopping aft taken_from_inside_of_tbsitsS1wc"
             stop
          endif
  ...
  subroutine stepUp_variables(stepNo,step,IftS,IftC,A0_inpt,A0_rnge,ka_inpt,ka_rnge,l0_inpt,l0_rnge,ks_inpt,ks_rnge)
    ...
    ! open(unit=132,file="Echeck_PT.dat")
    
    ! if (CellsMeet .ge. 5) then
       
    !    EsV=0.0d0 ; EaV=0.0d0
       
    !    do i = 1,N_spr
    !       EsV = EsV + k_spr(i)*((l(i)-l0(i))**2)
    !       write(132,*) k_spr(i),l(i),l0(i),EsV,i,"EsV"
    !    enddo
       
    !    write(132,*) " "
       
    !    do i = 1,N_cell
    !       EaV = EaV + k_area(i)*((A(i)-A0(i))**2)
    !       write(132,*) k_area(i),A(i),A0(i),EaV,i,"EaV"
    !    enddo
    ...
    do i = 1,2
       ...
       do j = 1,jmax
          ...
          elseif (i==2) then
             ...
             elseif (IftC(j).ne.1 .and. IftC(j).ne.2 .and. IftC(j).ne.3) then
  ...
  subroutine taken_from_inside_of_tbsitsS1wc ! == trnsfrm_btn_strcts_inTwoStps_S1_with_cndn
    ...
    forMakingCellsMeet = 1 ! IMPORTANT LINE 
    ...
    if (forMakingCellsMeet==1) then
       ...
       call tilt_reduction_of_the_boundry(forMakingCellsMeet,Exprmnt,Frame)
  ...
  subroutine deformation_tests_using_one_or_multiple_cells
    ...
    call redeine_system_for_changing_only_node_typ
    call Equilibrate_bothTN_NImodel(Exprmnt,Frame)
